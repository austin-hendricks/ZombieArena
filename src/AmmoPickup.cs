...
namespace HendricksAustin.Lab6
{
    public class AmmoPickup : MonoBehaviour
    {
        ...
        {
            if (!alreadyCollected && other.CompareTag("Player") && !PlayerHasMaxAmmo())
            {
                alreadyCollected = true;
                EventManager.Broadcast(Events.AddAmmoEvent);
        ...
        private bool PlayerHasMaxAmmo()
        {
            return WeaponController.Instance.EquippedHasMaxAmmo();
        }
    }
}
